...
class PurchaseCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Créer l'achat avec statut 'received' pour mise à jour automatique du stock
        validated_data['status'] = 'received'  # Auto-réception pour les tests
        purchase = Purchase.objects.create(**validated_data)

        # Créer les items
        total_amount = 0
        for item_data in items_data:
            # Définir quantity_received = quantity_ordered pour auto-validation
            quantity_ordered = item_data['quantity_ordered']
            quantity_received = item_data.get('quantity_received', quantity_ordered)  # Auto-réception
        ...
        # Mettre à jour le montant total et marquer comme validé
        purchase.total_amount = total_amount
        purchase.status = 'validated'  # Marquer comme validé automatiquement
        purchase.save()
